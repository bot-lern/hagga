...
RAVANA.addCommand({pattern: 'rhelp', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.addCommand({pattern: '1', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
