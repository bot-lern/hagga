...
if (config.WORKTYPE == 'private') {
    ...
    Asena.addCMD({pattern: 'asong ?(.*)', fromMe: true, desc: Lang.SONG_DESC}, (async (message, match) => {
...
Asena.addCMD({pattern: 'asong ?(.*)', fromMe: false, desc: Lang.SONG_DESC}, (async (message, match) => {
